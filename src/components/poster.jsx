    ...
    <section className="">
      <div className="bg-[url(/assets/icons/main.gif)] bg-no-repeat bg-cover bg-center border-y-4 border-brand-accent">
        <div className="flex flex-col gap-3 max-w-110  py-[10%] ml-[10%] ">
          ...
          <div className="">
            <button
              className="w-max font-secondary text-primary-text uppercase tracking-tighter font-semibold text-normal px-3.5 py-2 bg-brand-accent hover:bg-brand-accent-dark hover:scale-110 rounded-md transition delay-100 duration-200 easy-in cursor-pointer"
              type="button"
            >
              test drive !
            </button>
