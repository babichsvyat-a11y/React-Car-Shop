      ...
      {loading ? (
        ...
        <main className="flex flex-col gap-20 p-[10%] bg-light-simp-bg dark:bg-primary-background">
              ...
              <ul className="flex flex-row gap-4">
                {auto.color.map((color) => {
                  return (
                    <li
                      key={color.name}
                      className="gap-1 flex flex-col text-wrap w-12.5 lg:w-18.75"
                    >
                      <div className={color.value}></div>
                      <p className=" break-normal font-primary text-xs md:text-sm font-bold uppercase text-center dark:text-primary-text text-light-accent leading-none transition delay-100 duration-200 easy-in">
                        {color.name}
                      </p>
                    </li>
                  );
          ...
          <div className="flex md:flex-row flex-col-reverse justify-between gap-8 md:gap-auto">
            ...
            <div className="md:w-4/9 w-full bg-light-bg dark:bg-primary-background p-8 flex flex-col gap-4">
              <div className="flex flex-col gap-4">
                <h2 className="font-primary text-2xl lg:text-4xl font-black uppercase dark:text-primary-text text-light-accent text-center leading-none transition delay-100 duration-200 easy-in">
